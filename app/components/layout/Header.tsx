        ...
        <div className="flex h-20 items-center justify-between gap-4">
          ...
          <div className="mx-8 hidden max-w-lg flex-1 md:flex">
            <div className="group relative w-full">
              ...
              <input
                className="block w-full rounded-lg border border-gray-200 bg-[#f9fbf9] p-2.5 pr-10 text-sm text-gray-900 outline-none transition-all placeholder:text-gray-400 focus:border-secondary focus:ring-secondary dark:border-gray-700 dark:bg-[#233523] dark:text-white dark:placeholder:text-gray-400"
